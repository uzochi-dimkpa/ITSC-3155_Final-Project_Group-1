...
-- Sample entries:
REPLACE INTO t_user (username, user_password, first_name, last_name, bio, num_friends)
VALUES
...
REPLACE INTO t_post (user_id, title, body, created_at, updated_at)
VALUES
...
REPLACE INTO t_comment (post_id, user_id, comment_text, created_at, updated_at)
VALUES
